<?php
    ...
    {
        render("apology.php", NULL, NULL, NULL,NULL, ["message" => $message]);
    }
     ...
     */
    function render($view, $view1 , $view2, $view3 = NULL, $view4 = NULL, $values = [])
    {
        ...
        if (file_exists("../views/{$view}"))
        {
            ...
            if($view == "history_form.php")
            {
                ...
                //require("../views/middle_course_modify.php");
            }
            ...
            if($view4 !== NULL)
            {
                //if($view4 !== "history_form_1.php")
                    require("../views/middle_course_modify.php");
                //else
                 //   require("../views/middle_bookmark_modify.php");
                //require("../views/middle_sbookmark.php");
                require("../views/{$view4}");
            }
            //require("../views/{$view2}");
